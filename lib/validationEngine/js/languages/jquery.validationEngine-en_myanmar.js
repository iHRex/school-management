        ...
        newLang: function(){
			...
			"func": function (field) {
			 ...
			 "alertText": "* Invalid date, must be in YYYY-MM-DD format"
				...
				{
                   // "regex": /^[0-9a-zA-Z\u1000-\u109F\ \_\,\`\.\'\^\-\&\+\n\!\"\%\(\)\*\/\:\=\?\@\[\]\{\|\}\~]+$/,
				   "regex": /^([^\x00-\x80]|[0-9a-zA-Z\u1000-\u109F\ \_\,\`\.\'\^\-\&\+])+$/,
                    "alertText": "* Only Letters,Numbers Characters Allowed And '$#<>;' Characters Are Not Allowed"
                },
